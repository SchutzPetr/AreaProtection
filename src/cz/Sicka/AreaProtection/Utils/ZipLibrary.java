...
public class ZipLibrary {
    public static final File BACKUP_DIR = new File(AreaProtection.getInstance().getDataFolder(), "Backup");
    ...
    public static void backup() throws IOException {
        ...
        File saveFolder = new File(AreaProtection.getInstance().getDataFolder(), "Save");
        ...
        for (World world : AreaProtection.getInstance().getServer().getWorlds()) {
            saveFile = new File(worldFolder, "areas_" + world.getName() + ".yml");
            if (saveFile.isFile()) {
    ...
    public static void prune() {
        ...
        AreaProtection.LogMessage("Cleaned backup files. Deleted " + amountDeleted + " of " + amountTotal + " files.");

        for (File file : toDelete) {
            if (!file.delete()) {
            	 AreaProtection.LogMessage("Failed to delete: " + file.getName());
            }
        }
    }
